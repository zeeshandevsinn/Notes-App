class Note {
  ...
  // Convert a Note instance to a regular map
  ...
  // Convert a Note instance to a Firestore map
  ...
  // Create a Note instance from a regular map
  ...
  // Create a Note instance from Firestore document
  factory Note.fromFirestore(Map<String, dynamic> data) {
    return Note(
      ...
      modifiedTime: data['modifiedTime'] != null
          ? DateTime.parse(data['modifiedTime'])
          : DateTime.now(), // Handle default value or error case
    );
  }

  // Create a Note instance from Firestore document map
  factory Note.fromDocument(doc) {
    ...
    return Note(
      ...
      title: data['title'],
      content: data['content'],
      modifiedTime: DateTime.parse(data['modifiedTime']),
    );
  }
}
